...
Player.prototype.update = function() {
    ...
    if (this.currentkey === 'left' && this.x !== 0) {
        this.x = this.x - 101;
    } else if (this.currentkey === 'right' && this.x != 400) {
        this.x = this.x + 101;
    } else if (this.currentkey === 'up') {
        this.y = this.y - 83;
    } else if (this.currentkey === 'down' && this.y != 400) {
        this.y = this.y + 83;
    }
    // setting value of currentKey to null will give player a hop movement
